...
<template>
  <div class="login-module-page">
    ...
    <VanForm ref="formRef" autocomplete="off" @submit="handleLogin">
      ...
      >
        <template #button>
          <ILoginEyeOn v-if="loginFormData.showPassword" @click="loginFormData.showPassword = !loginFormData.showPassword" />
          <ILoginEyeOff v-else @click="loginFormData.showPassword = !loginFormData.showPassword" />
        </template>
      </VanField>
      <VanField
        v-else
